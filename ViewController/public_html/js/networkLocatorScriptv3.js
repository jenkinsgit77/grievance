...
function googlePlaces(event) {
    ...
    var places = new google.maps.places.Autocomplete(document.getElementsByClassName("txtPlaces")[0].children[0]);
        ...
        google.maps.event.addListener(marker, 'click', (function (marker, i) {
            return function () {
              ...
              if(finalData[i].NetworkType == "AreaOffice"){
                infowindow.setContent('<div style="white-space:pre-wrap;width:250px;"><strong>' + finalData[i].OfficeName + '</strong><br/><br/>' + finalData[i].Address + '<br/>' + finalData[i].Email + '<br/>' + finalData[i].PhoneNo +'<br/><a href="javascript:void(0)" onclick="getDirection(\'' + finalData[i].Latitude+ '\',\''+finalData[i].Longitude+'\',\''+finalData[i].Address+'\')">Get direction</a></div>');
              }else if(finalData[i].NetworkType == "RetailOutlet"){
                infowindow.setContent('<div style="white-space:pre-wrap;width:250px;"><strong>' + finalData[i].ROName + '</strong><br/><br/>' + finalData[i].ROaddress + '<br/><strong>Dealer : </strong>' + finalData[i].DealerName + '<br/><strong>Phone No : </strong>' + finalData[i].Telephone+'<br/>'+finalData[i].Email+ '<br/><strong>MS : </strong>' + finalData[i].MS + '<br/><strong>HSD : </strong>' + finalData[i].HSD + '<br/><strong>XP : </strong>' + finalData[i].XP + '<br/><strong>XM : </strong>' + finalData[i].XM+ '<br/><strong>Amenities : </strong>' + finalData[i].ROServices +'<br/><a href="javascript:void(0)" onclick="getDirection(\'' + finalData[i].Latitude+ '\',\''+finalData[i].Longitude+'\',\''+finalData[i].ROaddress+'\')">Get direction</a></div>');
              }else if(finalData[i].NetworkType == "Distributor"){
                infowindow.setContent('<div style="white-space:pre-wrap;width:250px;"><strong>' + finalData[i].PartnerName + '</strong><br/><br/>' + finalData[i].Address + '<br/>' + finalData[i].Pin + '<br/>' + finalData[i].CustStateName +'<br/><strong>Phone No : </strong>'+finalData[i].Telephone +'<br/>'+finalData[i].Email +'<br/><a href="javascript:void(0)" onclick="getDirection(\'' + finalData[i].Latitude+ '\',\''+finalData[i].Longitude+'\',\''+finalData[i].Address+'\')">Get direction</a></div>');
              }else{
