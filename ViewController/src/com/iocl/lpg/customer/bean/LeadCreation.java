...
public class LeadCreation implements Serializable{
    ...
    public LeadCreation() {
        ...
        if (logFlag != null && "Y".equalsIgnoreCase(logFlag)) {
            ...
            logger = Logger.getLogger(LeadCreation.class);
    ...
    public String onClickLeadSubmit() {
        ...
        if (errorInLead == true) {
            ...
            if(errorInLead == false) {
                    ...
                    jsonInput.put("Remarks", String.valueOf(remarksBinding.getValue()).equalsIgnoreCase("null")?"" :String.valueOf(remarksBinding.getValue()).trim());
    ...
    public void onClickLeadReset(ActionEvent actionEvent) {
        ...
        resetLeadValidation();
            ...
            lastNameBinding.setValue("");
            middleNameBinding.setValue("");
            cityBinding.setValue("");
            pincodeBinding.setValue("");
            mobileNoBinding.setValue("");
            address1Binding.setValue("");
            address2Binding.setValue("");
            lineofbussbinding.setValue("");
            landbankbinding.setValue("");
            remarksBinding.setValue("");
